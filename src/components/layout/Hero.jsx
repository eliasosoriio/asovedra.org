      ...
      <div className="w-full min-h-screen flex flex-col">
         ...
         <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="text-white/90 text-lg md:text-xl lg:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
               Red de apoyo en Galicia y parte de España. Brindamos acompañamiento integral a la comunidad
               iberoamericana con programas de orientación en migración, empleo e
               integración social.
            </p>
         </div>
