...
const personalizedNavTheme = {
  "root": {
    "base": "fixed mt-6 w-full bg-white shadow-[6px_6px_9px_rgba(0,_0,_0,_0.2)] px-3 py-3 mx-auto min-mx- max-w-7xl sm:px-4 dark:border-0 dark:bg-transparent animate-fade-in-down top-0 left-0 right-0",
    "rounded": {
      "on": "rounded",
      "off": ""
    },
