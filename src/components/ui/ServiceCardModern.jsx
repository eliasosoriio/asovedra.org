...
function ServiceCardModern({ title, description, icon, color = "primary-blue" }) {
  ...
  return (
    <div className={`group relative p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer ${colorClasses[color] || colorClasses['primary-blue']}`}>
