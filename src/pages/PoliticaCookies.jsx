...
function PoliticaCookies() {
  return (
    <>
      ...
      >
                <h2 className="text-2xl font-bold text-white mb-6">Política de Cookies de ASOVEDRA.org</h2>
                ...
                <h3 className="text-xl font-semibold text-white mb-4">¿Qué son las cookies?</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Uso de cookies en ASOVEDRA</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Control de cookies</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Consentimiento</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Las cookies de esta web ayudan a:</h3>
                ...
                <h3 className="text-xl font-semibold text-white mb-4">No utilizamos cookies para:</h3>
                <ul className="mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Tipos de cookies utilizadas</h3>

                <h4 className="text-lg font-semibold text-white mb-3">Cookies técnicas</h4>
                <p className="mb-6">
                ...
                <h4 className="text-lg font-semibold text-white mb-3">Cookies de Google Analytics</h4>
                <p className="mb-4">
                ...
                <h4 className="text-lg font-semibold text-white mb-3">Cookies de redes sociales</h4>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">¿Cómo desactivar cookies?</h3>
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Cookies específicas que utiliza esta web</h3>
                <ul className="mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Responsabilidad</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Aceptación</h3>
                <p className="mb-6">
