    ...
    <>
      ...
      >
            <div className="space-y-8">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">¿Quién recopila tus datos?</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">¿Qué datos personales tenemos?</h2>
                <p className="text-slate-300 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Finalidad de tener datos</h2>
                <p className="text-slate-300 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">¿Qué derechos tienes?</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Derecho de información:</h3>
                    <p className="text-slate-300 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Derecho de acceso:</h3>
                    <p className="text-slate-300 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Derecho de rectificación:</h3>
                    <p className="text-slate-300 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Derecho de supresión:</h3>
                    <p className="text-slate-300 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Derecho de oposición al marketing directo:</h3>
                    <p className="text-slate-300 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Derecho de portabilidad de los datos:</h3>
                    <p className="text-slate-300 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Derecho a la desactivación de cookies:</h3>
                    <p className="text-slate-300 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">¿Cuánto tiempo conservamos datos?</h2>
                <p className="text-slate-300 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Datos Identificativos</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Información No Identificable</h2>
                <p className="text-slate-300 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Uso del Portal</h2>
                <p className="text-slate-300 leading-relaxed mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Legislación Aplicable y Jurisdicción</h2>
                <p className="text-slate-300 leading-relaxed">
