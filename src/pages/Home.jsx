...
function Home() {
  return (
    <main
      className='flex flex-col items-center justify-center text-center px-3 py-8 gap-10'
    >
      <section>
      ...
      <section>
        ...
        {/* Primer bloque: texto izquierda, imagen derecha */}
        <div className="flex flex-col md:flex-row items-center max-w-3xl mx-auto gap-8 mb-8">
      ...
      <section>
        <h2 className='text-2xl text-primary-dark font-bold mb-6'>Nuestros Servicios</h2>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
          <ServiceCard title={"Servicio 1"} image={"https://www.diariodepontevedra.es/asset/thumbnail,1280,720,center,center/media/diariodepontevedra/images/2019/08/03/2019080312114328443.jpg"} />
          <ServiceCard title={"Servicio 2"} image={"https://www.diariodepontevedra.es/asset/thumbnail,1280,720,center,center/media/diariodepontevedra/images/2025/07/22/2025072215310571656.jpg"} />
          <ServiceCard title={"Servicio 3"} image={"https://glcabogados.es/wp-content/uploads/2025/05/GLCAbogados-y-Asovedra-en-Congreso-diputados-1080x675.jpeg"} />
          <ServiceCard title={"Servicio 4"} image={"https://estaticos-cdn.prensaiberica.es/clip/6ca270d8-4225-483d-9f2d-3f2c7b94f1ba_16-9-discover-aspect-ratio_default_0.jpg"} />
        </div>
        <button className='mt-8 px-6 py-3 bg-primary-gray text-white rounded-lg hover:bg-primary-dark transition-colors cursor-pointer'>
